---
name: prd-writer
description: Dispatched by the main thread when brainstorming resolves a prd-trd or prd-only route. Consumes brainstorming's route payload and produces `.planning/{session_id}/PRD.md`.
