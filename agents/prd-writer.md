---
name: prd-writer
description: Dispatched by the main thread when harness-flow.yaml routes a prd-trd or prd-only session to PRD drafting. Consumes brainstorming's route payload and produces `.planning/{session_id}/PRD.md`.
