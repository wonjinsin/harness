---
name: trd-writer
description: Dispatched by the main thread when flow.yaml routes a Tier-A (PRD→TRD) or Tier-C (direct-to-TRD) session. Consumes the classifier or prd-writer payload and produces `.planning/{session_id}/TRD.md`.
